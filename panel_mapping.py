...
def create_radio_panel_1(verbose):
    panel1 = RadioPanel(usb_bus=0, usb_address=1, verbose=verbose)
...
def create_radio_panel_2(verbose):
    panel2 = RadioPanel(usb_bus=0, usb_address=2, verbose=verbose)
